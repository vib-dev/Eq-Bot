...
- Reuters support is implemented as an optional scraper adapter because Reuters does not provide a free public API for this use case. That means availability may change and usage should respect site terms.
...
- `/report` top material announcements since the last market close
- `/dailyreport` latest daily consolidated announcement digest
